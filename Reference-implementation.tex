...
\noindent {\bf Example 3. $RImp(S_{\textit{ORS}})$}: $li$ and $cor$ is defined as follows: 
...
\noindent {\bf Example 4. $RImp(S_{\textit{list}})$}: $li$ and $cor$ is defined as follows: 
...
\noindent {\bf Example 5. The case of OR-set}: Given $q=(O,ro,del,arb,vis)$ and add operation $o$ where $cont(o)=add(a,\top)$, $Minus(q,o) = \{o' \vert cont(o')=rem(\top,a), o {\xrightarrow{vis}} o', \neg \exists o'',$ such that $( cont(o'') = rem(\top,a) ) \wedge ( o {\xrightarrow{vis}} o'' {\xrightarrow{vis}} o' ) \}$.
...
\noindent {\bf Example 6. The case of Distributed list}: Given $q=(O,ro,del,arb,vis)$ and add operation $o$ where $cont(o)=add(a,\top)$, $Minus(q,o) = \{o' \vert cont(o')=rem(\top,a), o {\xrightarrow{vis}} o', \neg \exists o'',$ such that $( cont(o'') = rem(\top,a) ) \wedge ( o {\xrightarrow{vis}} o'' {\xrightarrow{vis}} o' ) \}$.
