...
\item[-] Recognize the $\mathit{FstRem}$ relations: $\mathit{FstRem}((w_1,w_2,w_3)) = w_4$, while $w_1$ is of value $a$ and $f(w_4) = \mathit{rem}(a)$. %$w_1=(\_,a,\_,\_,\_)$ and $w_4 = ((\_,a,\_,\_,\_),\_,\_)$.
